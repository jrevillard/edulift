...
<head>
<meta charset="utf-8">
<title>EduLift - Login</title>
</head>
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
<h1 style="color: #2563eb;">EduLift</h1>
<p>Hello,</p>
...
<p style="color: #666; font-size: 12px;">EduLift - Collaborative school transport management</p>
</body>
</html>`;
  }
    ...
    return `
      ...
      <body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p style="color: #666; font-size: 12px;">
          EduLift - Collaborative school transport management
        </p>
      </body>
      </html>
    `;
